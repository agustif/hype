...
Item {
    ...
    readonly property bool outlined: ["open", "save", "visual", "markdown", "code", "history", "export", "bold", "italic", "headline", "comment", "media-add", "adjust", "chevron-down"].indexOf(name) >= 0
